...
.card-label{position:absolute;bottom:4px;left:0;right:0;text-align:center;font-size:3.5rem;font-weight:900;color:#003087;letter-spacing:1px;z-index:2;text-shadow:0 1px 3px rgba(0,0,0,0.4);}.card-back .diamond{position:relative;z-index:1;width:44%;aspect-ratio:1;background:rgba(255,255,255,0.25);transform:rotate(45deg);border:3px solid rgba(255,255,255,0.7);border-radius:4px;}
